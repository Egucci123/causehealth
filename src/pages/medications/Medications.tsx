    ...
    return (
      <div className="min-h-screen bg-[#FAF9F5] px-6 pt-8 pb-32 font-['Manrope',sans-serif]">
        <div className="animate-pulse space-y-6">
          ...
          <div className="h-40 bg-[#EFEEEA] rounded-[32px]" />
        </div>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-[#F4F4F0] rounded-xl px-4 py-2.5 text-[#01261F] text-[10px] uppercase tracking-[0.15em] font-bold"
        >
      ...
      <div className="min-h-screen bg-[#FAF9F5] px-6 pt-8 pb-32 font-['Manrope',sans-serif] space-y-12">
        ...
        <div className="flex flex-col items-center text-center pt-4">
          <div className="relative w-20 h-20 flex items-center justify-center mb-6">
            <Pill className="w-16 h-16 text-[#E3E2DF]/60" />
            <Plus className="w-10 h-10 text-[#E3E2DF]/60 absolute -bottom-1 -right-1" />
          </div>
          <h2 className="font-['Fraunces',serif] italic text-2xl text-[#01261F] mt-6">
            No medications tracked
          </h2>
          <p className="text-sm text-[#414846] mt-3 leading-relaxed max-w-[280px]">
        ...
        <div className="bg-[#F4F4F0] rounded-[32px] p-8">
          <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#01261F]">
            PHILOSOPHY
          </span>
          <h3 className="font-['Fraunces',serif] italic text-2xl text-[#01261F] mt-3">
            Root Cause Medicine
          </h3>
          <p className="text-sm text-[#414846] mt-3 leading-relaxed">
        ...
        <div className="bg-[#F4F4F0] rounded-[32px] p-8">
          ...
          <h3 className="font-['Fraunces',serif] italic text-xl text-[#01261F] mt-3">
      ...
      {activeMed && primaryDepletion ? (
        ...
        <div className="space-y-5">
                ...
                <button
                  ...
                  className={`shrink-0 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-[0.15em] transition-colors ${
                    i === selectedMedIdx
                      ...
                      : 'bg-white text-[#414846] shadow-[0_8px_32px_-4px_rgba(27,28,26,0.06)]'
                  }`}
                >
                  {m.info.generic_name}
                </button>
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            <h2 className="font-['Fraunces',serif] italic text-3xl text-[#01261F] leading-tight">
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#414846]/60">
              Active Prescription
            </span>
            <h2 className="font-['Fraunces',serif] italic text-2xl text-[#01261F] mt-2 capitalize">
            ...
            <div className="flex items-center justify-center gap-4 mt-6">
              <div className="w-14 h-14 rounded-2xl bg-[#F4F4F0] flex items-center justify-center">
                <Pill className="w-6 h-6 text-[#01261F]" />
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 h-[2px] bg-[#83A69C]" />
                <span className="text-[9px] text-[#414846]/60 mt-1 uppercase tracking-[0.2em]">blocks</span>
              </div>
              <div className="w-14 h-14 rounded-2xl bg-[#F4F4F0] flex items-center justify-center">
                <svg className="w-6 h-6 text-[#01261F]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                  <path d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                </svg>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-8 h-[2px] bg-[#FFDAD6]" />
                <span className="text-[9px] text-[#414846]/60 mt-1 uppercase tracking-[0.2em]">depletes</span>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 h-2 rounded-full overflow-hidden flex">
                ...
                <div className="flex-1 bg-[#83A69C]/30" />
              </div>
              <div className="flex justify-between mt-1.5">
                <span className="text-[10px] text-[#BA1A1A] font-semibold">Deficient</span>
                <span className="text-[10px] text-[#01261F] font-semibold">Optimal</span>
              </div>
            ...
            <div className="mt-5 space-y-2">
              {activeMed.info.depletes.map((dep) => (
                <div key={dep.nutrient} className="flex items-center justify-between py-2">
                  <span className="text-sm font-medium text-[#01261F]">{dep.nutrient}</span>
                  <span
          ...
          >
            ...
            <p className="text-sm text-[#414846] mt-2 leading-relaxed">
            ...
            {primaryDepletion.important_note && (
              <p className="text-xs text-[#414846]/70 mt-3 italic">
                {primaryDepletion.important_note}
              </p>
            )}
          ...
          {medications
            ...
            .map((med) => {
              ...
              return (
                ...
                >
                  <div>
                    <p className="text-sm font-semibold text-[#01261F] capitalize">{med.name}</p>
                    <p className="text-xs text-[#414846]">
                      {med.dose}{med.frequency && ` \u2022 ${FREQUENCY_OPTIONS.find((o) => o.value === med.frequency)?.label || med.frequency}`}
                    </p>
                    {isLooking && (
                      <p className="text-[10px] text-[#01261F] mt-1">Looking up depletions...</p>
                    )}
                  </div>
                  <button
            ...
            {medications.map((med) => (
              <div key={med.id} className="inline-flex gap-2 items-center">
                <button
                  ...
                  className="text-xs text-[#01261F] underline underline-offset-2"
                >
                  Edit {med.name}
                </button>
                <button
                ...
                <span className="text-[#414846]/30 mx-1">|</span>
              </div>
            ))}
          </div>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="font-['Fraunces',serif] italic text-lg text-[#01261F] capitalize">
                      {med.name}
                    </h3>
                    <p className="text-xs text-[#414846] mt-1">
                      {med.dose}
                  ...
                  <div className="flex gap-1">
                    <button onClick={() => openEdit(med)} className="p-2 text-[#414846]/60">
                      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                {isLooking && (
                  <p className="text-[10px] text-[#01261F] mt-3">Looking up depletion data...</p>
                )}
                {!info && !isLooking && (
                  <p className="text-xs text-[#414846]/50 mt-3">No known depletions</p>
                )}
              </motion.div>
            );
          })}
...
function AddMedicationModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Drag handle */}
        <div className="w-10 h-1 rounded-full bg-[#414846]/20 mx-auto mb-5" />

        <h2 className="font-['Fraunces',serif] text-xl text-[#01261F] mb-5">
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#414846]/40" />
              <input
                type="text"
                value={formName}
                onChange={(e) => onNameChange(e.target.value)}
                placeholder="Start typing a medication name..."
                className="w-full bg-[#F4F4F0] rounded-xl border border-[#C1C8C4]/20 pl-11 pr-4 py-3.5 text-sm text-[#01261F] placeholder:text-[#414846]/40 outline-none focus:ring-2 focus:ring-[#1A3C34]/20"
                autoFocus
              />
            </div>
            <AnimatePresence>
              {showSuggestions && (
                ...
                >
                  {suggestions.map((s) => (
                    <button
                      key={s}
                      className="w-full text-left px-4 py-3 text-sm text-[#01261F] hover:bg-[#F4F4F0] transition-colors"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#F4F4F0] rounded-xl border border-[#C1C8C4]/20 px-4 py-3.5 text-sm text-[#01261F] placeholder:text-[#414846]/40 outline-none focus:ring-2 focus:ring-[#1A3C34]/20"
              />
            </div>
            <div>
              <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#414846] mb-2 block">
              ...
              <select
                ...
                className="w-full bg-[#F4F4F0] rounded-xl border border-[#C1C8C4]/20 px-4 py-3.5 text-sm text-[#01261F] outline-none focus:ring-2 focus:ring-[#1A3C34]/20 appearance-none"
              >
          ...
          <AnimatePresence>
            {depletionPreview && (
              ...
              >
                <div className="bg-[#F4F4F0] rounded-2xl p-4">
                  <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#01261F]">
          ...
          <div className="flex gap-3 pt-2">
            <button
              onClick={onClose}
              className="flex-1 rounded-xl py-4 text-sm font-bold uppercase tracking-[0.15em] text-[#414846] bg-[#F4F4F0]"
            >
              Cancel
            </button>
            <button
